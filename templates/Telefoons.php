<div class="text-center ml-5 mr-5">
    <h4 class="font-rubik font-size-20">Telefoons</h4>
    </div>
    <div class="text-right mr-5"><a href="?Telefoonssortbyprice"><i class="text-right zmdi zmdi-money"></i></a></div>
    ...
    <?php
        ...
        if (isset($_GET['Telefoonssortbyprice'])) {
            $sql = "SELECT * FROM products WHERE cat = 'Telefoons' ORDER BY old_price ASC";
        } else {
        $sql = "SELECT * FROM products WHERE cat = 'Telefoons'";}
