<div class="text-center ml-5 mr-5">
        <h4 class="font-rubik font-size-20">Desktops</h4>
    </div>
    <div class="text-right mr-5"><a href="?Desktopssortbyprice"><i class="text-right zmdi zmdi-money"></i></a></div>
    ...
    <div class="container">
        ...
        <?php
            ...
            if (isset($_GET['Desktopssortbyprice'])) {
                $sql = "SELECT * FROM products WHERE cat = 'Desktops' ORDER BY old_price ASC";
            } else {
            $sql = "SELECT * FROM products WHERE cat = 'Desktops'";}
