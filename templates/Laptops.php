<div class="text-center ml-5 mr-5">
    ...
    <div class="text-right mr-5"><a href="?Laptopssortbyprice"><i class="text-right zmdi zmdi-money"></i></a></div>
    ...
    <?php
        ...
        if (isset($_GET['Laptopssortbyprice'])) {
            $sql = "SELECT * FROM products WHERE cat = 'Laptops' ORDER BY old_price ASC";
        } else {
        $sql = "SELECT * FROM products WHERE cat = 'Laptops'";}
